...
#define CHINESE_SYSTEM(x) [UIFont fontWithName:CHINESE_FONT_NAME size:x * ([UIScreen mainScreen].bounds.size.width/375)]
//缩放比例(参照iPhone 6)
#define autoScaleX [UIScreen mainScreen].bounds.size.width/375
#define autoScaleY [UIScreen mainScreen].bounds.size.height/668
//支持横屏
...
// 随机色
#define kRandomColor JWColor(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256))
